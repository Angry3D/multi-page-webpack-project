...
function getStyleLoaders(extractCss, loaders) {
    return [extractCss ? MiniCssExtractPlugin.loader : 'style-loader', 'css-loader', ...loaders]
}

function getCssPlugins(extractCss) {
    if (!extractCss) {
        return []
    }
        ...
        module: {
            rules: [
                ...
                },
                {
                    // less
                    test: /\.less$/i,
                    use: getStyleLoaders(extractCss, ['less-loader'])
                },
                {
                    // css / pcss
                    test: /\.(css)|(pcss)$/i,
                    use: getStyleLoaders(extractCss, ['postcss-loader'])
                },
                {
                    // js
                    test: /\.js$/,
